...
Once the design doc is APPROVED, deliver the closing sequence. This is two beats with a deliberate pause between them. Every user gets both beats regardless of mode (startup or builder). The intensity varies by founder signal strength, not by mode.
...
### Beat 2: Founder Signal Tier Summary
...
After the tier summary, suggest the next step:
